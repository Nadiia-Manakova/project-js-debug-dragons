import{g as T,s as b,a as y,h as p,b as x,c as N,w as _,d as B,e as M,f as I}from"./assets/icons-sprite-1c427646.js";import{N as v,a as L,b as j}from"./assets/vendor-23f73890.js";const g=document.querySelector(".list_general"),O=document.querySelector(".title_best_sellers");let d=0,n=window.innerWidth;window.addEventListener("resize",R);function R(t){const e=t.target.outerWidth;(e>767&&n<768||e>1439&&n<1440||e<1440&&n>1439||e<768&&n>767)&&location.reload()}const W=()=>{n<768?d=1:n>=768&&n<1440?d=3:d=5};T().then(t=>{console.log(t),J(t)}).catch(t=>{v.Notify.failure("An error occurred while fetching images. Please try again.")});function D(){b();let t=this.getAttribute("data-my-attribute");console.log(t),H(t),y(t).then(e=>{O.style.display="none",g.innerHTML="",w(e)}).catch(e=>{v.Notify.failure("An error occurred while fetching images. Please try again.")})}function H(t){const e=document.querySelector(".categories__title"),s=document.querySelector(".categories__list").getElementsByTagName("li"),i=Array.from(s).find(a=>a.textContent.trim()===t);i&&(i.classList.add("selected-category"),e.style.color="var(--text-color)")}function K(t){return t.books.slice(0,d).map(e=>{let o=E(e),s=S(e);return`
