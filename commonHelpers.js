import{g as N,a as E,s as w,h as S,b as j}from"./assets/burgerMenu-7ef6a74f.js";import{N as $,a as C,b as I}from"./assets/vendor-542f1b53.js";const m=document.querySelector(".list_general"),W=document.querySelector(".title_best_sellers");let u=0,l=window.innerWidth;window.addEventListener("resize",O);function O(e){const t=e.target.outerWidth;(t>767&&l<768||t>1439&&l<1440||t<1440&&l>1439||t<768&&l>767)&&location.reload()}const R=()=>{l<768?u=1:l>=768&&l<1440?u=3:u=5};N().then(e=>{console.log(e),Y(e)}).catch(e=>{$.Notify.failure("An error occurred while fetching images. Please try again.")});function H(){let e=this.getAttribute("data-my-attribute");console.log(e),K(e),E(e).then(t=>{W.style.display="none",m.innerHTML="",x(t)}).catch(t=>{$.Notify.failure("An error occurred while fetching images. Please try again.")})}function K(e){const t=document.querySelector(".categories__title"),s=document.querySelector(".categories__list").getElementsByTagName("li"),c=Array.from(s).find(g=>g.textContent.trim()===e);c&&(c.classList.add("selected-category"),t.style.color="var(--text-color)")}function z(e){return e.books.slice(0,u).map(t=>{let o=q(t),s=A(t);return`
