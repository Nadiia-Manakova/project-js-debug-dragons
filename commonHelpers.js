import{g as q,s as p,a as y,h as b,b as T,c as x,d as N,w as _,e as B,f as M,i as I}from"./assets/icons-sprite-5b43a8b1.js";import{N as v,b as j}from"./assets/vendor-4b8b63a3.js";const g=document.querySelector(".list_general"),O=document.querySelector(".title_best_sellers");let d=0,n=window.innerWidth;window.addEventListener("resize",R);function R(e){const t=e.target.outerWidth;(t>767&&n<768||t>1439&&n<1440||t<1440&&n>1439||t<768&&n>767)&&location.reload()}const W=()=>{n<768?d=1:n>=768&&n<1440?d=3:d=5};q().then(e=>{console.log(e),J(e)}).catch(e=>{v.Notify.failure("An error occurred while fetching images. Please try again.")});function D(){p();let e=this.getAttribute("data-my-attribute");console.log(e),H(e),y(e).then(t=>{O.style.display="none",g.innerHTML="",S(t)}).catch(t=>{v.Notify.failure("An error occurred while fetching images. Please try again.")})}function H(e){const t=document.querySelector(".categories__title"),s=document.querySelector(".categories__list").getElementsByTagName("li"),l=Array.from(s).find(a=>a.textContent.trim()===e);l&&(l.classList.add("selected-category"),t.style.color="var(--text-color)")}function K(e){return e.books.slice(0,d).map(t=>{let o=L(t),s=E(t);return`
