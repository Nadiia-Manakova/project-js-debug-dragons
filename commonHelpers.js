import{g as j,a as w,s as S,h as $,b as I,c as W,w as v}from"./assets/burgerMenu-96705cf7.js";import{N as C,a as A,b as O}from"./assets/vendor-36465543.js";const h=document.querySelector(".list_general"),R=document.querySelector(".title_best_sellers");let g=0,i=window.innerWidth;window.addEventListener("resize",H);function H(e){const t=e.target.outerWidth;(t>767&&i<768||t>1439&&i<1440||t<1440&&i>1439||t<768&&i>767)&&location.reload()}const K=()=>{i<768?g=1:i>=768&&i<1440?g=3:g=5};j().then(e=>{console.log(e),Y(e)}).catch(e=>{C.Notify.failure("An error occurred while fetching images. Please try again.")});function z(){let e=this.getAttribute("data-my-attribute");console.log(e),P(e),w(e).then(t=>{R.style.display="none",h.innerHTML="",T(t)}).catch(t=>{C.Notify.failure("An error occurred while fetching images. Please try again.")})}function P(e){const t=document.querySelector(".categories__title"),o=document.querySelector(".categories__list").getElementsByTagName("li"),d=Array.from(o).find(b=>b.textContent.trim()===e);d&&(d.classList.add("selected-category"),t.style.color="var(--text-color)")}function D(e){return e.books.slice(0,g).map(t=>{let s=q(t),o=x(t);return`
