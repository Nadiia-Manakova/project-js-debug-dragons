import{g as N,a as v,s as L,h as E,b as j,c as R,w as I}from"./assets/burgerMenu-42594b0c.js";import{N as w,a as S,b as W}from"./assets/vendor-3361d7a0.js";const g=document.querySelector(".list_general"),O=document.querySelector(".title_best_sellers");let m=0,i=window.innerWidth;window.addEventListener("resize",H);function H(e){const t=e.target.outerWidth;(t>767&&i<768||t>1439&&i<1440||t<1440&&i>1439||t<768&&i>767)&&location.reload()}const K=()=>{i<768?m=1:i>=768&&i<1440?m=3:m=5};N().then(e=>{console.log(e),Y(e)}).catch(e=>{w.Notify.failure("An error occurred while fetching images. Please try again.")});function z(){let e=this.getAttribute("data-my-attribute");console.log(e),P(e),v(e).then(t=>{O.style.display="none",g.innerHTML="",C(t)}).catch(t=>{w.Notify.failure("An error occurred while fetching images. Please try again.")})}function P(e){const t=document.querySelector(".categories__title"),s=document.querySelector(".categories__list").getElementsByTagName("li"),d=Array.from(s).find(h=>h.textContent.trim()===e);d&&(d.classList.add("selected-category"),t.style.color="var(--text-color)")}function D(e){return e.books.slice(0,m).map(t=>{let o=$(t),s=A(t);return`
