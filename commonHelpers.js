import{i as Z,g as Q,o as ee,c as te,u as oe,s as se,a as ne,b as j,d as ie,r as D,e as le,f as ae,h as p,N as H,j as re,P as ce}from"./assets/vendor-1ac408a8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();const a={body:document.querySelector("body"),checkbox:document.querySelector(".header-theme-checkbox"),THEME_KEY:"headerTheme",themeValueLight:"light-theme",themeValueDark:"dark-theme"};function de(){a.checkbox.checked===!0&&(localStorage.setItem(a.THEME_KEY,a.themeValueDark),a.body.classList.add("dark-theme")),a.checkbox.checked===!1&&(localStorage.getItem(a.THEME_KEY,a.themeValueLight),a.body.classList.remove("dark-theme"))}a.checkbox.addEventListener("click",de);const ue={apiKey:"AIzaSyC8186vhxW_ZDU8EVA4gnzNG0ku3rRXkNY",authDomain:"awesome-project-1330c.firebaseapp.com",projectId:"awesome-project-1330c",storageBucket:"awesome-project-1330c.appspot.com",messagingSenderId:"235904211325",appId:"1:235904211325:web:cd87abc5d9f719d2d41414",measurementId:"G-WDSXDZDNLB",databaseURL:"https://awesome-project-1330c-default-rtdb.europe-west1.firebasedatabase.app"};Z(ue);const d=Q(),l={signUpBox:document.querySelector(".js-sign-up"),signInBox:document.querySelector(".js-sign-in"),signUpForm:document.querySelector(".js-sign-up-form"),signInForm:document.querySelector(".js-sign-in-form"),signUpBtn:document.querySelector(".js-sign-up-link"),signInBtn:document.querySelector(".js-sign-in-link"),exitBtn:document.querySelector(".js-sign-out-btn"),openModalBtn:document.querySelector(".auth-modal-open"),closeModalBtn:document.querySelector(".auth-modal-close"),modal:document.querySelector(".auth-modal-backdrop")};l.signInBtn.addEventListener("click",me);l.signUpBtn.addEventListener("click",ge);l.signUpForm.addEventListener("submit",pe);l.signInForm.addEventListener("submit",he);l.openModalBtn.addEventListener("click",v);l.closeModalBtn.addEventListener("click",v);l.exitBtn.addEventListener("click",ye);function v(){l.modal.classList.toggle("auth-backdrop-hidden")}function me(e){e.preventDefault(),l.signUpBox.classList.add("auth-hidden"),l.signInBox.classList.remove("auth-hidden"),l.signUpBtn.classList.remove("active"),l.signInBtn.classList.add("active")}function ge(e){e.preventDefault(),l.signUpBox.classList.remove("auth-hidden"),l.signInBox.classList.add("auth-hidden"),l.signUpBtn.classList.add("active"),l.signInBtn.classList.remove("active")}function pe(e){e.preventDefault();const t=new FormData(e.currentTarget),o={};t.forEach((s,n)=>{o[n]=s}),fe(o.email,o.password,o.username)}function he(e){e.preventDefault();const t=new FormData(e.currentTarget),o={};t.forEach((s,n)=>{o[n]=s}),be(o.email,o.password)}ee(d,e=>{e?(e.displayName,e.email,e.photoURL,e.uid,console.log("User is signed in, we will show all modules")):console.log("User is signed out, we will hide some modules")});function fe(e,t,o){te(d,e,t).then(()=>oe(d.currentUser,{displayName:o})).then(()=>{v(),console.log(`Welcome, ${o}!`)}).catch(s=>{const n=s.code,i=s.message;console.log(n,i)})}function be(e,t){se(d,e,t).then(o=>{const s=o.user;console.log(`Welcome, ${s.displayName}!`),v()}).catch(o=>{const s=o.code,n=o.message;console.log(s,n)})}function ye(){ne(d).then(()=>{console.log("Sign-out successful.")}).catch(e=>{console.log(`An error happened. ${e}`)})}function O(){const e=d.currentUser;if(e!==null){const t={name:e.displayName,email:e.email,photo:e.photoURL,uid:e.uid};return console.log(t),t}else console.log('User is signed out. This function will return "undefined".')}function ke(e){if(!e){console.log("No data to write!");return}const t=O();if(!t){console.log("User is not authorized!");return}const o=t.uid,s=j();ie(D(s,"users/"+o),{books:e}),console.log("Success!")}function ve(){const e=O();if(!e){console.log("User is not authorized!");return}const t=e.uid,o=D(j());le(ae(o,`users/${t}`)).then(s=>{if(s.exists())return console.log(s.val()),s.val();console.log("No data available")}).catch(s=>{console.log(s)})}const Le=document.querySelector(".dbw");Le.addEventListener("click",Se);function Se(){ke([{list_name:"Advice How-To and Miscellaneous"},{list_name:"Audio Fiction",books:Array(5)},{list_name:"Audio Nonfiction",books:Array(5)},{list_name:"Business Books",books:Array(5)},{list_name:"Childrens Middle Grade Hardcover",books:Array(5)},{list_name:"Combined Print and E-Book Fiction",books:Array(5)}])}const we=document.querySelector(".dbr");we.addEventListener("click",ve);const P="https://books-backend.p.goit.global/books/";async function F(){const e=`${P}top-books`;return(await p.get(e)).data}const Ee="https://books-backend.p.goit.global/books/";async function R(e){const t=`${Ee}category?category=${e}`;return(await p.get(t)).data}async function _e(){const e=`${P}category-list`;return await p.get(e)}const Be=document.querySelector(".title_best_sellers"),L=document.querySelector(".list_general");let b=0,$=window.innerWidth;$>=996?b=5:$>=720?b=3:$>=240&&(b=1);F().then(e=>{console.log(e),Ce(e)}).catch(e=>{H.Notify.failure("An error occurred while fetching images. Please try again.")});function $e(){let e=this.getAttribute("data-my-attribute");R(e).then(t=>{Be.style.display="none",L.innerHTML="",W(t)}).catch(t=>{H.Notify.failure("An error occurred while fetching images. Please try again.")})}function Ae(e){return e.books.slice(0,b).map(t=>{let o=K(t),s=G(t);return`
