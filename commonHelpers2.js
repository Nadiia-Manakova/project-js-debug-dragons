import"./assets/burgerMenu-2d9fe4fb.js";import{P as k}from"./assets/vendor-e8a5e68e.js";const c="booklist",o=document.querySelector("#pagination"),l=document.querySelector(".cart-list"),p=document.querySelector(".empty-cart"),r=3,S=3;p.style.display="none";let t=[];try{t=JSON.parse(localStorage.getItem(c)),t.length||(p.style.display="block"),t.length<=r&&(o.style.display="none"),l.innerHTML=g(t,1)}catch(e){console.error("Get state error: ",e.message)}const $={totalItems:t.length,itemsPerPage:r,visiblePages:S,page:1,centerAlign:!1,template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}"></span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};let i=new k(o,$);document.addEventListener("click",L);i.on("afterMove",e=>{let a=e.page;l.innerHTML=g(t,a),console.log("currentPage Global after :>> ",a)});function g(e,a){l.innerHTML="";const s=r*(a-1),n=s+r;return e.slice(s,n).map(({_id:d,author:y,book_image:h,title:m,description:f,buy_links:[{url:b},{url:v}],list_name:P})=>` <li class="cart-item" data-id ="${d}">
